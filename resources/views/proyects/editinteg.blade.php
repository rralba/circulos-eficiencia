          ...
          <div class="modal-body">
             ...
             <div class="row">
               <div class="col clearfix">
                ...
                <div class="col-xs-4"><input class="form-control form-control-sm" id="fname" type="text" placeholder="Nombre de empleado" name="firstname" required readonly>
                </div>
               </div>
             </div>
             <div class="row">
               <div class="col clearfix">
                ...
                <div class="col-xs-4"><input class="form-control form-control-sm" id="lname" type="text" placeholder="Departamento" name="lastname" required readonly></div>
               </div>
            </div>
            <div class="row">
               <div class="col clearfix">
                <div class="col-xs-2"><label><b>Posicion</b></label></div>
                <div class="col-xs-4"><input class="form-control form-control-sm" id="gender" type="text" placeholder="posicion" name="lastname" required readonly></div>
               </div>
            </div>
            <div class="row">
               <div class="col clearfix">
                <div class="col-xs-2"><label><b>Nivel</b></label></div>
                <div class="col-xs-4"><input class="form-control form-control-sm" id="email" type="email" placeholder="nivel" name="email" required readonly></div>
               </div>
            </div>
             <div class="row">
               <div class="col clearfix">
             ...
             <div class="row">
               <div class="col clearfix">
                ...
                <div class="col-xs-4"><input class="form-control form-control-sm" id="salary" type="text" placeholder="Direccion" name="salary" required readonly></div>
               </div>
            </div>
             <div class="row">
               <div class="col clearfix">
                <div class="col-xs-2"><label><b>Compañia</b></label></div>
                <div class="col-xs-4"><input class="form-control form-control-sm" id="cia" type="text" placeholder="Compañia" name="cia" required readonly></div>
               </div>
            </div> 
