	...
	<div class="imprime">
		<div class="conta">
            <div class="left col-md-4 m-0 p-0">
                <img src="{!! asset('jpg/logoce.jpg') !!}" class="float-center" alt="Logo de circulos de eficiencia" width="330" height="100">
            </div>
      ...
      <div class="row">
	        <div class="form-group row col-md-6 justify-content-start">
	...
	<input type="hidden" id="var" name="var" value="{{ $mejora->desperdicio }}">	
      ...
      <div class="row">
				...
				<div class="form-group row col-md-7">
					<label for="inputEmail4" class="ml-4 p-3"><h3>Otros Conceptos:</h3></label>
      ...
      <div class="row">
	        ...
	        <div class="form-group row col-md-5">
	        	...
	        	<input type="text" class="form-control ml-4" style="width: 80%" id="direccion" name="direccion" value="{{ $integrante->nombre }}" readonly>	
	        </div>
	        <div class="form-group row col-md-2">
	         	<label for="inputEmail4"><h3>Ficha</h3></label>
	         	<input type="text" class="form-control ml-4" style="width: 50%" id="direccion" name="direccion" value="{{ $integrante->pivot->empleado_id }}" readonly>
	        </div>
	        ...
	        <div class="form-group row col-md-2">
	         	...
	         	<input type="text" class="form-control ml-4" style="width: 50%" id="direccion" name="direccion" value="{{ $integrante->cia }}" readonly>
	        </div>
      </div>
      @else
      <div class="row">
      ...
      <div class="row">
	        <div class="form-group row col-md-12">
	        	<label for="recipient-name" class="col-form-label ml-4"><h3>¿Qué debe mejorarse?</h3></label>
	        	<textarea class="form-control ml-4" rows="3" id="direccion" name="direccion" readonly>{{ $mejora->amejorar }}</textarea>
	        </div>
      </div>
      <div class="row">
	        <div class="form-group row col-md-12">
	        	<label for="recipient-name" class="col-form-label ml-4"><h3>Objetivo</h3></label>
	        	<textarea class="form-control ml-4" rows="3" id="direccion" name="direccion" readonly>{{ $mejora->objetivo }}</textarea>
	        </div>
      </div>
      <div class="row">
	        <div class="form-group row col-md-12">
	        	<label for="recipient-name" class="col-form-label ml-4"><h3>Solución</h3></label>
	        	<textarea class="form-control ml-4" rows="3" id="direccion" name="direccion" readonly>{{ $mejora->solucion }}</textarea>
	        </div>
      </div>
      <br>
      <br>
